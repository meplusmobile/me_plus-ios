    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              '${AppLocalizations.of(context)!.t('error_picking_image')}: $e',
            ),
  ...
  Future<void> _submit() async {
    if (_formKey.currentState!.validate()) {
      ...
      context
          ...
          .updateItem(widget.reward.id, name, price, imageToSend)
          .then((_) {
            if (mounted) {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
          ...
          .catchError((error) {
            if (mounted) {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(
                    '${AppLocalizations.of(context)!.t('error_updating_reward')}: $error',
                  ),
                  backgroundColor: Colors.red,
                ),
              );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          AppLocalizations.of(context)!.t('edit_reward'),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: _selectedImage != null
                      ...
                      : widget.reward.image?.isNotEmpty == true
                      ? ClipRRect(
                          borderRadius: BorderRadius.circular(16),
                          child: Image.network(
                            widget.reward.image!,
